...
Welcome to `carsales` contributor's guide.
...
If you experience bugs or general issues with `carsales`, please have a look
...
You can help improve `carsales` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`carsales` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `carsales`'s files. While this mechanism can
...
```
conda create -n carsales python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/carsales.git
   cd carsales
   ```
...
5. Install [pre-commit]:
   ...
   `carsales` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/carsales
[issue tracker]: https://github.com/<USERNAME>/carsales/issues
